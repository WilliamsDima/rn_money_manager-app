...
export const FillSvg = (props) => (
  <Svg
    ...
    style={{
      enableBackground: "new 0 0 224.827 224.827",
    }}
    xmlSpace="preserve"
    {...props}
  >
